...
DocumentStructure _$DocumentStructureFromJson(Map<String, dynamic> json) =>
    DocumentStructure(
      ...
      (json['pages'] as List<dynamic>)
          .map((e) =>
              DocumentStructurePageSize.fromJson(e as Map<String, dynamic>))
          .toList(),
      DocumentHierarchyElement.fromJson(
          json['hierarchy'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$DocumentStructureToJson(DocumentStructure instance) =>
    <String, dynamic>{
