...
DocumentHierarchyElement _$DocumentHierarchyElementFromJson(
    ...
    DocumentHierarchyElement(
      ...
      (json['pageLocations'] as List<dynamic>)
          .map((e) => PageLocation.fromJson(e as Map<String, dynamic>))
          .toList(),
      (json['layoutErrorMeasurements'] as List<dynamic>)
          .map((e) => DocumentHierarchyElementLayoutErrorMeasurement.fromJson(
              e as Map<String, dynamic>))
          .toList(),
      (json['properties'] as List<dynamic>)
          .map((e) => ElementProperty.fromJson(e as Map<String, dynamic>))
          .toList(),
      json['sourceCodeDeclarationPath'] == null
          ? null
          : SourceCodePath.fromJson(
              json['sourceCodeDeclarationPath'] as Map<String, dynamic>),
      (json['children'] as List<dynamic>)
          .map((e) =>
              DocumentHierarchyElement.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$DocumentHierarchyElementToJson(
        DocumentHierarchyElement instance) =>
    <String, dynamic>{
