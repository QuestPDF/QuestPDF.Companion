...
GenericExceptionStackFrame _$GenericExceptionStackFrameFromJson(
...
Map<String, dynamic> _$GenericExceptionStackFrameToJson(
        GenericExceptionStackFrame instance) =>
    <String, dynamic>{
