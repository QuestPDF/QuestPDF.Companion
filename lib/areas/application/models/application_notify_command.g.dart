...
ApplicationNotifyCommand _$ApplicationNotifyCommandFromJson(Map<String, dynamic> json) =>
    ApplicationNotifyCommand(json['clientId'] as String, $enumDecode(_$LicenseTypeEnumMap, json['license']));
